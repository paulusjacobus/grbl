...
#define cpu_map_h
  ...
  #define Y_LIMIT_BIT      2  // Uno Digital Pin 10
  #ifdef VARIABLE_SPINDLE // Z Limit pin and spindle enabled swapped to access hardware PWM on Pin 11.
    #define Z_LIMIT_BIT	   1 //4 // Uno Digital Pin 12
  #else
  ...
  // Z Limit pin and spindle PWM/enable pin swapped to access hardware PWM on Pin 11.
      ...
      #define SPINDLE_ENABLE_BIT    5  // Uno Digital Pin 13 (NOTE: D13 can't be pulled-high input due to LED.)
    #else
      #define SPINDLE_ENABLE_BIT    5 //3  // Uno Digital Pin 11
    #endif
  #else
    #define SPINDLE_ENABLE_BIT    5 //4  // Uno Digital Pin 12
  #endif
  #ifndef USE_SPINDLE_DIR_AS_ENABLE_PIN
    #define SPINDLE_DIRECTION_DDR   DDRB
    #define SPINDLE_DIRECTION_PORT  PORTB
  ...
  // Variable spindle configuration below. Do not change unless you know what you are doing.
  // NOTE: Only used when variable spindle is enabled.
  #define SPINDLE_PWM_MAX_VALUE     1023 // 328PB 10bit=1023,11=2047,12=4095,13=8191,14=16383,15=32767,16=65535
  #ifndef SPINDLE_PWM_MIN_VALUE
    #define SPINDLE_PWM_MIN_VALUE   1   // Must be greater than zero.
  #endif
  #define SPINDLE_PWM_OFF_VALUE     0
  ...
  // Prescaled, 10-bit fast PWM mode.
...
// phase correct pwm
  ...
  #define SPINDLE_PWM_BIT	  1    // Uno Digital Pin 1
#endif
