...
#define defaults_h
  ...
  #define DEFAULT_X_STEPS_PER_MM 315.0
  #define DEFAULT_Y_STEPS_PER_MM 315.0
  ...
  #define DEFAULT_X_MAX_TRAVEL 330.0 // mm
  #define DEFAULT_Y_MAX_TRAVEL 230.0 // mm
...
//#define DEFAULT_PWM_MODE 10 // number
//#define DEFAULT_PWM_PRESCALER 8 // number
#endif
